...
class SecondViewController: UIViewController, UITableViewDelegate,UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        myc.lblname.text = appdel.globalarr[indexPath.row].value(forKey: "carname") as! String
        myc.lblprice.text = appdel.globalarr[indexPath.row].value(forKey: "carprice") as! String
        myc.lblavg.text = appdel.globalarr[indexPath.row].value(forKey: "caravg") as! String
        myc.lblcompany.text = appdel.globalarr[indexPath.row].value(forKey: "carcompany") as! String
